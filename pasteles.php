    ...
    <div class="contenedor">
                      ...
                      <article class="container-cards">
                          <div class="cardimg">
                              <div class="slide-contenedor">
                                <div class="miSlider fade">
                                   <img src="img/chocolate.jpg" class="card_img"> 
                                </div>
                                <div class="miSlider fade" style="display:none">
                                   <img src="img/fresa.jpg" class="card_img"> 
                                </div>
                                <div class="miSlider fade" style="display:none">
                                   <img src="img/velvet.jpg" class="card_img"> 
                                </div>
                                <div class="miSlider fade" style="display:none">
                                   <img src="img/carrot.jpg" class="card_img"> 
                                </div>
                                <div class="miSlider fade" style="display:none">
                                   <img src="img/blackberry.jpg" class="card_img"> 
                                </div>
                          ...
                          <div class="card">
                              ...
                              <p class="card_text">Deliciosos pasteles elaborados con ingredientes de alta calidad, 
                                elige entre los distintos sabores que tenemos disponibles para ti. </p>
                             
                              <a class="card_button">Sabor</a>
                              <select name="sabor" class="sabor">
                              <option value="$$$">Selecciona un sabor</option>
                              <?php
                                $pasteles="SELECT * FROM pasteles";
                                $resultado=mysqli_query($db,$pasteles);
                                while ($valores = mysqli_fetch_array($resultado)){
                                  echo '<option value ="$'.$valores[precio_pastel].'.00">'.$valores[nombre_pastel].'</option>';
                                }
                                ?>
                             </select>
